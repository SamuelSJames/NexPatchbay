...
image:nexsession.svg["icon", 100, 100] image:patchance.svg["icon", 100, 100] image:patchichi.svg["icon", 100, 100]

Bienvenue sur le manuel de HoustonPatchbay, la baie de brassage pour JACK utilisée dans NexSession, Patchance et Patchichi.
...
Un clic droit n'importe où sur la baie de brassage permet d'en afficher le menu. Ce menu est également présent dans le menu de NexSession (menu *Baie de brassage*).
