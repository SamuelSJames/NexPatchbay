...
Welcome to the HoustonPatchbay manual, the JACK patchbay used in NexSession, Patchance and Patchichi.
...
Right click anywhere on the patchbay to display the menu. This menu is also present in the NexSession menu (*Patchbay* menu).
